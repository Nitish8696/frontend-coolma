    ...
    <div className="w-full">
      <div className="w-full border-b ">
        ...
        <div className="sm:w-[85%] w-full flex justify-between sm:px-5 px-3 m-auto items-center sm:py-2 ">
          ...
          />
          <div
            className={`md:hidden bg-white fixed w-[100%] top-0 overflow-y-auto bottom-0 py-4 pl-4 z-[999] duration-500 ${
              isOpen ? "left-0" : "-left-full"
            } transition-all ease-in-out`}
          >
            <div className="inline-block text-xl font-semibold">Home</div>
