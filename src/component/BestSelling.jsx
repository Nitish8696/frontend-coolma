...
const Bestdeal = () => {
  ...
  return (
    <div className=" w-full sm:flex justify-evenly items-center m-auto">

      <div className="px-5 py-3 sm:w-[30%] w-full flex sm:block justify-between items-center">
        <h1 className="sm:text-4xl text-2xl font-bold sm:pb-5 ">Best Deals</h1>
        ...
        <button className="sm:px-7 px-3 sm:py-3 sm:bg-[#00AFEF] sm:text-white text-[#00AFEF] border border-[#00AFEF] sm:rounded-none rounded-xl">
          View All
        </button>
      </div>
            ...
            <Link to={`/product/${product.name}`} key={index}>
              <div className="rounded-[10px] border flex flex-col mx-2 relative">
                ...
                <div className="mt-4 m-auto text-center p-2">
                  ...
                  <p className="text-gray-700 font-bold text-sm py-3">
                    ₹{product.price}
                  </p>
                </div>
                <button
